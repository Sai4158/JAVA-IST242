...
public class Employee
{
    ...
    public Employee(String name, int id, String department, int number, String adname, String state, int zipcode)
    {
        this.name = name;
        this.id = id;
        this.department = department;
        this.address = new Address(number, adname,state,zipcode);
    }
